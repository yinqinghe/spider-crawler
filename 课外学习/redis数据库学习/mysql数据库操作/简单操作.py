...
sql_table="create table upData(字段 varchar(60)null,value varchar(20)null )"
cursor.execute(sql_table)
# sql="alter table vedioData add id int auto_increment primary key "#增加一个自增字段   且这个键必须设为主键
# cursor.execute(sql)
# create_table()
