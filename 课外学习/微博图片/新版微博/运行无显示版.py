...
cookie=open("D:\C#\python\爬虫\课外学习\cookie.txt",mode='r',encoding='utf-8')#读取cookie
...
def Get_page(page, uid,displayYear,curMonth,stat_date):
    headers = {
        ...
        'referer': 'https://weibo.com/u/6915153646?lpage=profileRecom',
        'sec-ch-ua-mobile': '?0',
...
if __name__ == '__main__':
    ...
    uid = ['3224882012']#林妙茜
    # uid = ['1192515960']#李冰冰
    # uid=['6448920093']#ins女神
    # uid=['6915153646']
    a = Get_page(13, uid[0], 2021, 6, 202106)
